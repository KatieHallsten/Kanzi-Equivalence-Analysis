...
plot_data %>% 
  rename(Accuracy = estimate) %>% 
  ggplot(aes(Modality, Accuracy, fill = Modality)) + 
  geom_col() + 
  scale_fill_manual(values = c("#F0E442", "#D55E00", "#009E73")) +
    scale_y_continuous(expand=c(0,0),limits=c(0,1.05),breaks = c(0,0.25,0.50,0.75,1),
                     labels=c(0,25,50,75,100),name="% Correct") +
  theme(axis.text.x = element_text(size=21)) +
  theme(axis.text.y = element_text(size=18)) +
  theme(axis.title.y = element_text(size=26, margin=margin(r=10,l=5))) +
  theme(axis.title.x = element_text(size=26, margin=margin(t=10,b=5))) +
  ...
  theme_classic() +
  xlab("Condition") +
  geom_text(data=ast2,aes(x=x,y=y+0.01,label=label),size=6,inherit.aes=FALSE) +
  theme(legend.position = "none")  # optional: hide legend

ggsave(filename="acc-by-cond.png",device="png",height=3.59,width=3.99,units="in") 
```
...
plot_data2 %>% 
  ...
  theme_classic() +
  xlab("Condition") +
  geom_text(data=ast22,aes(x=x,y=y+0.01,label=label),size=6,inherit.aes=FALSE) +
  theme(legend.position = "none")  # optional: hide legend

ggsave(filename="acc-by-cond-2.png",device="png",height=3.59,width=3.99,units="in") 
```
